      ...
      <header className="sticky top-0 z-50 border-b border-border bg-bg/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link
              to="/register"
              className="rounded-md bg-accent px-4 py-2 font-display text-sm font-medium text-bg transition-opacity hover:opacity-90"
            >
              sign up
            </Link>
          </div>
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="mt-2 flex flex-col gap-3 border-t border-border pt-4">
                ...
                <Link
                  to="/register"
                  onClick={() => setIsOpen(false)}
                  className="rounded-md bg-accent px-4 py-2 text-center font-display text-sm font-medium text-bg transition-opacity hover:opacity-90"
                >
                  sign up
                </Link>
              </div>
